...
st.markdown("Car ki details bharo aur ML model se price estimate karo!")
st.divider()
...
if st.button("🔍 Predict Car Price"):
    ...
    with c2:
        ...
        st.info(f"Dataset average: **${avg_price:,.0f}**. Your car is **${abs(diff):,.0f}** {'above' if diff > 0 else 'below'} average.")

st.divider()
st.markdown(
    "<center style='color:gray;font-size:0.85rem;'>Built with ❤️ using scikit-learn & Streamlit | Model: Gradient Boosting</center>",
    unsafe_allow_html=True
)
